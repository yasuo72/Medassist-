...
import 'package:medassist_plus/services/family_service.dart';
import 'package:medassist_plus/screens/family_member_profile_screen.dart';
...
class _FamilyManagementScreenState extends State<FamilyManagementScreen> {
  ...
  Future<void> _addMember() async {
    await _showAddMemberModal(context);
    await _loadMembers();
  }
  ...
  Future<void> _showAddMemberModal(
    ...
    String? _selectedRelation = isEditing ? member.relationship : null;
    String _medicalTag = isEditing ? member.medicalTag : '';
    String _emergencyId = isEditing ? member.emergencyId : '';
    ...
    await showModalBottomSheet(
      ...
      builder: (BuildContext ctx) {
        return StatefulBuilder(
          // Needed to update dropdowns within the modal
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      const Color(0xFF005266),
                      const Color(0xFF007991).withOpacity(0.9),
                    ], // Darker shade of the screen gradient
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        TextFormField(
                          ...
                          decoration: _inputDecoration(
                            'Medical Tag (e.g., Asthma, Healthy)',
                        ...
                        ElevatedButton.icon(
                          ...
                          onPressed: () async {
                            try {
                              ...
                              await FamilyService().uploadSummary(file);
                              modalSetState(() {
                                _medicalTag = 'Summary uploaded';
                              }); // Optionally store url somewhere
                              if (context.mounted) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text('Summary uploaded'),
                                  ),
                                );
                              }
                            } catch (e) {
                                  ...
                                  if (isEditing) {
                                    final updatedMember = FamilyMember(
                                      ...
                                      medicalTag: _medicalTag,
                                       ...
                                       summaryUrl: null,
                                      avatarUrl:
                                          member.avatarUrl, // Preserve avatar
                                    );
                                    setState(() {
          ...
          itemBuilder: (context, index) {
            ...
            return Dismissible(
              ...
              child: InkWell(
                ...
                onLongPress: () => _editMember(member),
                child: Card(
